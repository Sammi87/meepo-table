import { Component, DefineComponent, ComputedRef, Ref } from "vue";
import { ComponentProps } from "vue-component-type-helpers";
import { AlignX, SortType, SortingDirection } from "@/types/enums";
import { CommonProps, Cell } from "@/types/cellTypes";
...
export type AlternativeValue<T, P extends CommonProps, K extends string> = { value: (data: T) => P[K], key: K };
...
export type PartialColumn<T, P extends CommonProps> = Partial<Column<P, T>> & { columnId: ColumnId }
...
export type TableOptions<T, S> = {
  ...
  initialSorting?: { column: string, direction: SortingDirection, sortingType?: SortType };
...
export type SubTableOptions<S> = {
  ...
  accordion?: boolean;
  hideHeaderCells?: boolean;
  initialSorting?: { column: string, direction: SortingDirection };
...
export type TableService<T, S> = {
  ...
  divideCellId: (cellId: CellId) => { columnId: ColumnId, rowId: RowId };
